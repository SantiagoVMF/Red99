                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav" >
                        <ul className="navbar-nav mx-auto" style={{ width: '100%', justifyContent: 'space-between', width:'90%', fontFamily: 'times new roman' }}> {/* Ajoutez mx-auto pour centrer */}
                            ...
                            <li className="nav-item">
                                <Link className='nav-link' style={{color: '#ffffff' }} to='#'>Nos Services</Link>
                            </li>
                            <li className="nav-item">
                                <Link className='nav-link' style={{color: '#ffffff' }} to="#">À propos</Link>
                            </li>
                            <li className="nav-item">
                                <Link className='nav-link' style={{color: '#ffffff' }} to="#">Se connecter</Link>
                            </li>  */}
                        </ul>
                    </div>
                </div>
